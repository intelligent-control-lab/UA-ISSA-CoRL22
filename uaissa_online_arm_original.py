...
def safe_guard_simulation(args):
    ...
    for i in range(args.maxIter):
        print(f'iteration {i}')
        # nonminal control no need to be super large 
        ddtheta1 = 0.0001*np.random.uniform(env.arm.ddtheta1_lim[0],env.arm.ddtheta1_lim[1])
        ddtheta2 = 0.0001*np.random.uniform(env.arm.ddtheta2_lim[0],env.arm.ddtheta2_lim[1])
...
if __name__ == "__main__":
    ...
    # if args.groundtruth:
    #     safe_guard_simulation_ground_truth(args)
