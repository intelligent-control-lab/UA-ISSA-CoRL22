...
def gp_dynamics_learning(args):
    ...
    for x_tau in X_tau:
        ...
        if phi(args, env, reverse_normalize(x_tau)) < 0:
            print(phi(args, env, reverse_normalize(x_tau)))
            print(phi(args, env, next_state))
            print()
...
def safe_guard_simulation(args):
    ...
    dataset_x_delta_theta1 = np.arange(0, 1, 0.001) # dtheta1
    ...
    dataset_x_delta_theta2 = np.arange(0, 1, 0.001) # dtheta2
    ...
    dataset_x_delta_dtheta1 = np.arange(0, 1, 0.001) # ddtheta1
    ...
    dataset_x_delta_dtheta2 = np.arange(0, 1, 0.001) # ddtheta2
